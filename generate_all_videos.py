...
Usage:
  python generate_all_videos.py                 # all stages, best of 3 eps
  python generate_all_videos.py --stages stage3b_noisy_mild stage4b_dr_finetune
  python generate_all_videos.py --evasive       # force an evasive target
  python generate_all_videos.py --episodes 5 --fps 20 --skip 2
  python generate_all_videos.py --format gif    # if ffmpeg unavailable
"""
