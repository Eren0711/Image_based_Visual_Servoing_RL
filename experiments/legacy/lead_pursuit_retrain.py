...
=============================================================
HISTORICAL / NON-CANONICAL: this exploratory equal-capability study is outside
fixed_camera_intercept_v1 and its outcome is not a universal guidance claim.
...
- Perception stack = the legacy eval_evasion stack (NoiseDelay + DKF + CBF context),
...
Run:  python experiments/legacy/lead_pursuit_retrain.py            # full run
      python experiments/legacy/lead_pursuit_retrain.py --figs-only
"""
...
def train_factory(cfg):
    def _init():
        ...
        c["target"]["inherit_interceptor_limits"] = True
