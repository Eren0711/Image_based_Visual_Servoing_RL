...
Usage:
    python scripts/diagnostics/depth_estimator_diagnostic.py --model logs/models/ibvs_ppo_final
    python scripts/diagnostics/depth_estimator_diagnostic.py --model logs/models/ibvs_ppo_final --episodes 5
