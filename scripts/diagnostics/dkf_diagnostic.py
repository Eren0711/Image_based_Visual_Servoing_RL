...
Usage:
    python scripts/diagnostics/dkf_diagnostic.py --stage stage2b
    python scripts/diagnostics/dkf_diagnostic.py --stage stage2b --model logs/stages/stage2b/models/ibvs_ppo_final --episodes 10
"""
...
def main():
    ...
    save_dir = args.save_dir or str(paths['stage_dir'] / 'dkf_test')
