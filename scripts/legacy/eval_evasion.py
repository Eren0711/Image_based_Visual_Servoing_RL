...
========================================================
HISTORICAL / NON-CANONICAL: this reconstructs the exploratory equal-capability
study; it is not the fixed_camera_intercept_v1 evaluation harness.
...
Usage:
  python scripts/legacy/eval_evasion.py --model <path> --level cruise --episodes 100
  python scripts/legacy/eval_evasion.py --model <path> --all-levels --episodes 100
"""
...
def build_env(cfg, level):
    ...
    # Preserve this historical study's equal-capability semantics. Canonical
    # v1 explicitly sets this false and gives the target lower limits.
...
def main():
    ...
    print(f"Model: {model_path}  (HardNet={hardnet})")
